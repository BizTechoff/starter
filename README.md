...
```sh
npx degit noam-honig/ev-app.git my-project
cd my-project
npm i
```
...
# Tutorial:
See [Creating a Fullstack Angular Remult app for non web developer](https://github.com/noam-honig/ev-app/wiki/Creating-a-Fullstack-Angular-Remult-app-for-non-web-developer)
